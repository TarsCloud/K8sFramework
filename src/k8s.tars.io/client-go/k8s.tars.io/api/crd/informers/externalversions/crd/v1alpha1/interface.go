...
type Interface interface {
	...
	// TReleases returns a TReleaseInformer.
	TReleases() TReleaseInformer
...
// TReleases returns a TReleaseInformer.
func (v *version) TReleases() TReleaseInformer {
	return &tReleaseInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
