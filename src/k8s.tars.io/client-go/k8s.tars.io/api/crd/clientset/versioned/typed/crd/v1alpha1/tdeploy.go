...
type TDeployInterface interface {
	Create(ctx context.Context, tDeploy *v1alpha1.TDeploy, opts v1.CreateOptions) (*v1alpha1.TDeploy, error)
	Update(ctx context.Context, tDeploy *v1alpha1.TDeploy, opts v1.UpdateOptions) (*v1alpha1.TDeploy, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.TDeploy, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.TDeployList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TDeploy, err error)
	TDeployExpansion
}
...
func newTDeploys(c *CrdV1alpha1Client, namespace string) *tDeploys {
	return &tDeploys{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tDeploys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TDeploy, err error) {
	result = &v1alpha1.TDeploy{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tdeploys").
		Name(name).
...
func (c *tDeploys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TDeployList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TDeployList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tdeploys").
...
func (c *tDeploys) Create(ctx context.Context, tDeploy *v1alpha1.TDeploy, opts v1.CreateOptions) (result *v1alpha1.TDeploy, err error) {
	result = &v1alpha1.TDeploy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tdeploys").
...
func (c *tDeploys) Update(ctx context.Context, tDeploy *v1alpha1.TDeploy, opts v1.UpdateOptions) (result *v1alpha1.TDeploy, err error) {
	result = &v1alpha1.TDeploy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tdeploys").
...
func (c *tDeploys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TDeploy, err error) {
	result = &v1alpha1.TDeploy{}
