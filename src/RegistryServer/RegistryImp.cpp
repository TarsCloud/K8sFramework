...
void RegistryImp::updateServerState(const string &podName, const string &settingState, const string &presentState, taf::CurrentPtr current) {
...
taf::Int32 RegistryImp::getServerDescriptor(const string &serverApp, const string &serverName, ServerDescriptor &serverDescriptor, taf::CurrentPtr current) {
