...
type tafAdminHandler struct {}

func (h *tafAdminHandler) ConfigureAPI(api *operations.TafadminOpenapiAPI) http.Handler {
...
func (h *tafAdminHandler) setupMiddlewares(handler http.Handler) http.Handler {
	return handler
}

// The middleware configuration happens before anything, this middleware also applies to serving the swagger.json document.
// So this is a good place to plug in a panic handling middleware, logging and metrics
func (h *tafAdminHandler) setupGlobalMiddleware(handler http.Handler) http.Handler {
	return handler
}
