...
// NewTarsadminOpenapiAPI creates a new TarsadminOpenapi instance
func NewTarsadminOpenapiAPI(spec *loads.Document) *TarsadminOpenapiAPI {
	return &TarsadminOpenapiAPI{
...
/*TarsadminOpenapiAPI Tars Admin接口文档 */
type TarsadminOpenapiAPI struct {
	spec            *loads.Document
...
func (o *TarsadminOpenapiAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *TarsadminOpenapiAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *TarsadminOpenapiAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *TarsadminOpenapiAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *TarsadminOpenapiAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *TarsadminOpenapiAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *TarsadminOpenapiAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *TarsadminOpenapiAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *TarsadminOpenapiAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the TarsadminOpenapiAPI
func (o *TarsadminOpenapiAPI) Validate() error {
...
func (o *TarsadminOpenapiAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *TarsadminOpenapiAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
	return nil
}

// Authorizer returns the registered authorizer
func (o *TarsadminOpenapiAPI) Authorizer() runtime.Authorizer {
	return nil
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *TarsadminOpenapiAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *TarsadminOpenapiAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *TarsadminOpenapiAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the tarsadmin openapi API
func (o *TarsadminOpenapiAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *TarsadminOpenapiAPI) initHandlerCache() {
...
func (o *TarsadminOpenapiAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *TarsadminOpenapiAPI) Init() {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
}
...
func (o *TarsadminOpenapiAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *TarsadminOpenapiAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *TarsadminOpenapiAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
