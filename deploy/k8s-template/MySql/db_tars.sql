...
--
-- Current Database: `_DB_TARS_DATABASE_`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `_DB_TARS_DATABASE_` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `_DB_TARS_DATABASE_`;
...
INSERT INTO `t_app` VALUES ('tars','','admin',current_timestamp,NULL);
...
INSERT INTO `t_auth` VALUES (8,NULL,'admin','admin',current_timestamp,NULL),(9,'tarslog','admin','krusli',current_timestamp,NULL);
...
CREATE TABLE `t_deploy_approval` (
  ...
  `f_server_servant` text DEFAULT NULL COMMENT '服务servant参数',
  `f_server_option` text DEFAULT NULL COMMENT '服务conf参数',
  `f_server_k8s` text DEFAULT NULL COMMENT '服务k8s参数',
...
CREATE TABLE `t_deploy_request` (
  ...
  `f_server_mark` text COMMENT '服务描述',
  `f_server_servant` text DEFAULT NULL COMMENT '服务servant参数',
  `f_server_option` text DEFAULT NULL COMMENT '服务option参数',
  `f_server_k8s` text DEFAULT NULL COMMENT '服务k8s参数',
...
INSERT INTO `t_server` VALUES (1,'tars','tarsnotify','','tars_cpp','admin',current_timestamp,'admin','System'),(2,'tars','tarsconfig','','tars_cpp','admin',current_timestamp,'admin','System'),(3,'tars','tarslog','','tars_cpp','admin',current_timestamp,'admin','System'),(4,'tars','tarsstat','','tars_cpp','admin',current_timestamp,'admin','System'),(5,'tars','tarsquerystat','','tars_cpp','admin',current_timestamp,'admin','System'),(6,'tars','tarsproperty','','tars_cpp','admin',current_timestamp,'admin','System'),(7,'tars','tarsqueryproperty','','tars_cpp','admin',current_timestamp,'admin','System');
...
CREATE TABLE `t_server_k8s` (
  ...
  `f_node_selector` text NOT NULL COMMENT 'Pod的亲和性与反亲和性配置',
  `f_host_port` text DEFAULT NULL COMMENT 'Pod 的 HostPort 配置',
  PRIMARY KEY (`f_server_id`),
...
INSERT INTO `t_server_k8s` VALUES (1,'tars','tarsnotify',1,0,0,0,'{\"Kind\": \"AbilityPool\", \"Value\": []}',NULL),(2,'tars','tarsconfig',1,0,0,0,'{\"Kind\": \"AbilityPool\", \"Value\": []}',NULL),(3,'tars','tarslog',1,0,0,0,'{\"Kind\": \"AbilityPool\", \"Value\": []}',NULL),(4,'tars','tarsstat',1,0,0,0,'{\"Kind\": \"AbilityPool\", \"Value\": []}',NULL),(5,'tars','tarsquerystat',1,0,0,0,'{\"Kind\": \"AbilityPool\", \"Value\": []}',NULL),(6,'tars','tarsproperty',1,0,0,0,'{\"Kind\": \"AbilityPool\", \"Value\": []}',NULL),(7,'tars','tarsqueryproperty',1,0,0,0,'{\"Kind\": \"AbilityPool\", \"Value\": []}',NULL);
...
CREATE TABLE `t_service_pool` (
  ...
  `f_image_detail` text DEFAULT NULL COMMENT '镜像元信息',
  `f_server_id` int(11) NOT NULL,
  `f_server_app` varchar(64) NOT NULL COMMENT '应用名',
  `f_server_name` varchar(64) NOT NULL COMMENT '服务名',
...
INSERT INTO `t_service_pool` VALUES (1,'10000',NULL,'_DOCKER_REGISTRY_URL_/tars.tarsnotify:10000','{}',1,'tars','tarsnotify','admin',current_timestamp),(2,'10000',NULL,'_DOCKER_REGISTRY_URL_/tars.tarsconfig:10000','{}',2,'tars','tarsconfig','admin',current_timestamp),(3,'10000',NULL,'_DOCKER_REGISTRY_URL_/tars.tarslog:10000','{}',3,'tars','tarslog','admin',current_timestamp),(4,'10000',NULL,'_DOCKER_REGISTRY_URL_/tars.tarsstat:10000','{}',4,'tars','tarsstat','admin',current_timestamp),(5,'10000',NULL,'_DOCKER_REGISTRY_URL_/tars.tarsquerystat:10000','{}',5,'tars','tarsquerystat','admin',current_timestamp),(6,'10000',NULL,'_DOCKER_REGISTRY_URL_/tars.tarsproperty:10000','{}',6,'tars','tarsproperty','admin',current_timestamp),(7,'10000',NULL,'_DOCKER_REGISTRY_URL_/tars.tarsqueryproperty:10000','{}',7,'tars','tarsqueryproperty','admin',current_timestamp);
