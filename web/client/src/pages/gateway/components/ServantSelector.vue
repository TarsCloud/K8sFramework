<template>
    <div class="select_wrapper">
        <let-select size="small" @change="changeSelect('application')" v-model="application" :title="application" class="select_item select_app" >
            <let-option v-for="d in applications" :key="d" :value="d"> {{d}} </let-option>
        </let-select>
        <let-select size="small" @change="changeSelect('server_name')" v-model="server_name" :title="server_name" class="select_item select_server" >
            <let-option v-for="d in serverNames" :key="d" :value="d"> {{d}} </let-option>
        </let-select>
        <let-select size="small" @change="changeSelect('obj')" v-model="obj" :title="obj" class="select_item  select_obj">
