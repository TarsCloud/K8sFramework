...
DCache.RouterParam = function() {
    ...
    this.serverName = "";
    this.appName = "";
    this.vtServerHost = new TafStream.List(TafStream.String);
    this.templateFile = "";
    this.dbName = "";
    this.dbIp = "";
    this.dbPort = "";
...
DCache.RouterParam.prototype = new TafStream.JceStruct();
...
DCache.RouterParam._readFrom = function (is) {
    ...
    tmp.vtServerHost = is.readList(3, true, TafStream.List(TafStream.String));
...
DCache.RouterConsistRes.prototype = new TafStream.JceStruct();
...
DCache.ProxyAddr.prototype = new TafStream.JceStruct();
...
DCache.ProxyParam = function() {
    this.bProxy = true;
    this.serverName = "";
    this.vtServerAddr = new TafStream.List(DCache.ProxyAddr);
    this.templateFile = "";
    this._classname = "DCache.ProxyParam";
};
DCache.ProxyParam.prototype = new TafStream.JceStruct();
...
DCache.ProxyParam._readFrom = function (is) {
    ...
    tmp.serverName = is.readString(1, true, "");
    tmp.vtServerAddr = is.readList(2, true, TafStream.List(DCache.ProxyAddr));
...
DCache.transferProgress.prototype = new TafStream.JceStruct();
...
DCache.CacheHostParam.prototype = new TafStream.JceStruct();
...
DCache.SingleKeyConfParam.prototype = new TafStream.JceStruct();
...
DCache.MultiKeyConfParam.prototype = new TafStream.JceStruct();
...
DCache.RecordParam.prototype = new TafStream.JceStruct();
...
DCache.DCacheUninstallInfo.prototype = new TafStream.JceStruct();
...
DCache.DCacheReleaseInfo.prototype = new TafStream.JceStruct();
...
DCache.eReleaseStatus.prototype = new TafStream.JceStruct();
...
DCache.DBInfo.prototype = new TafStream.JceStruct();
...
DCache.DBAccessConf = function() {
    ...
    this.tableEngine = "";
    this.tableCharset = "";
    this.vDBInfo = new TafStream.List(DCache.DBInfo);
    this._classname = "DCache.DBAccessConf";
};
DCache.DBAccessConf.prototype = new TafStream.JceStruct();
...
DCache.DBAccessConf._readFrom = function (is) {
    ...
    tmp.vDBInfo = is.readList(7, true, TafStream.List(DCache.DBInfo));
    tmp._jce_double_precision_ = is.readResumePrecision();
    return tmp;
};
...
DCache.moduleParam.prototype = new TafStream.JceStruct();
...
DCache.moduleServer.prototype = new TafStream.JceStruct();
...
DCache.transferInfo.prototype = new TafStream.JceStruct();
...
DCache.SwitchInfo.prototype = new TafStream.JceStruct();
...
DCache.CacheCond.prototype = new TafStream.JceStruct();
...
DCache.CacheData.prototype = new TafStream.JceStruct();
...
DCache.DCacheOptProxy.prototype.TransferDataExistGroup = function (appName, moduleName, srcGroupName, destGroupName, bTransferData, userName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.arguments.err = is.readString(7, true, TafStream.String);
    ...
    return this._worker.taf_invoke('TransferDataExistGroup', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.TransferOnlySetRouterDBV2 = function (appName, moduleName, srcGroupName, destGroupName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.err = is.readString(5, true, TafStream.String);
    ...
    return this._worker.taf_invoke('TransferOnlySetRouterDBV2', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.cacheIsSerializated = function (sAppName, sModuleName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.isSerializated = is.readBoolean(3, true, TafStream.Boolean);
            response.arguments.err = is.readString(4, true, TafStream.String);
    ...
    return this._worker.taf_invoke('cacheIsSerializated', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.changeCacheItem = function (sAppName, sModuleName, cacheType, vItem) {
    ...
    return this._worker.taf_invoke('changeCacheItem', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.checkDCacheRouteConfig = function (sHost, sUser, sPasswd, sDatabase, sCharSet, iPort, iFlag) {
    ...
    return this._worker.taf_invoke('checkDCacheRouteConfig', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.cleanExpandInfo = function (appName, moduleName, destGroupNames) {
    ...
    return this._worker.taf_invoke('cleanExpandInfo', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.cleanTransferInfo = function (appName, moduleName, srcGroupName) {
    ...
    return this._worker.taf_invoke('cleanTransferInfo', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.cleanUpDB = function (sAppName, sModuleName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.err = is.readString(3, true, TafStream.String);
    ...
    return this._worker.taf_invoke('cleanUpDB', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

DCache.DCacheOptProxy.prototype.configureExpand = function (appName, moduleName, sTafVersion, serverType, vtCacheHost) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        os.writeString(1, appName);
        os.writeString(2, moduleName);
        os.writeString(3, sTafVersion);
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.err = is.readString(6, true, TafStream.String);
    ...
    return this._worker.taf_invoke('configureExpand', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

DCache.DCacheOptProxy.prototype.configureTransfer = function (appName, moduleName, srcGroupName, sTafVersion, serverType, isDestServerExist, vtCacheHost) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        os.writeString(1, appName);
        os.writeString(2, moduleName);
        os.writeString(3, srcGroupName);
        os.writeString(4, sTafVersion);
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.err = is.readString(8, true, TafStream.String);
    ...
    return this._worker.taf_invoke('configureTransfer', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

DCache.DCacheOptProxy.prototype.configureTransferV2 = function (appName, moduleName, srcGroupName, sTafVersion, serverType, isDestServerExist, vtCacheHost) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        os.writeString(1, appName);
        os.writeString(2, moduleName);
    ...
    return this._worker.taf_invoke('configureTransferV2', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.dataRecover = function (sAppName, sServerName, serverType, lastTime) {
    ...
    return this._worker.taf_invoke('dataRecover', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.delMKCacheData = function (proxyObj, moduleName, sKey, cond) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.iRet = is.readInt32(5, true, TafStream.Int32);
            response.arguments.consumeTime = is.readInt32(6, true, TafStream.Int32);
            response.arguments.err = is.readString(7, true, TafStream.String);
    ...
    return this._worker.taf_invoke('delMKCacheData', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.delTCacheData = function (proxyObj, moduleName, sKey, keyType) {
    ...
    return this._worker.taf_invoke('delTCacheData', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.deleteTransferTask = function (appName, moduleName, srcGroup, destGroup, type) {
    ...
    return this._worker.taf_invoke('deleteTransferTask', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

DCache.DCacheOptProxy.prototype.expandDCache = function (appName, moduleName, serviceSetName, serviceName, vtCacheHost, sTafVersion, expandType, bReplace) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        os.writeString(1, appName);
        os.writeString(2, moduleName);
    ...
    var _decode = function (data) {
        try {
            ...
            response.arguments.err = is.readString(10, true, TafStream.String);
    ...
    return this._worker.taf_invoke('expandDCache', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getCangeItemProgress = function (sAppName, sModuleName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.process = is.readInt32(3, true, TafStream.Int32);
            response.arguments.err = is.readString(4, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getCangeItemProgress', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getCleanUpDBProgress = function (sAppName, sModuleName) {
    ...
    return this._worker.taf_invoke('getCleanUpDBProgress', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getDBConfInfo = function (dbaccessServerName) {
    ...
    return this._worker.taf_invoke('getDBConfInfo', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getDBDataSize = function (dbaccessServerName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.dataNum = is.readInt64(2, true, TafStream.Int64);
            response.arguments.err = is.readString(3, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getDBDataSize', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getExpandInfo = function (appName, moduleName) {
    ...
    return this._worker.taf_invoke('getExpandInfo', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getMKCacheData = function (proxyObj, moduleName, sKey, cond) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.cacheServerName = is.readString(5, true, TafStream.String);
            response.arguments.vtData = is.readList(6, true, TafStream.List(TafStream.Map(TafStream.String, DCache.CacheData)));
            response.arguments.dataNum = is.readInt32(7, true, TafStream.Int32);
            response.arguments.vDataSize = is.readList(8, true, TafStream.List(TafStream.Int32));
            response.arguments.totalSize = is.readInt32(9, true, TafStream.Int32);
            response.arguments.iRet = is.readInt32(10, true, TafStream.Int32);
            response.arguments.consumeTime = is.readInt32(11, true, TafStream.Int32);
            response.arguments.err = is.readString(12, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getMKCacheData', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getMKDBData = function (sAppName, sModuleName, dbaccessObj, sKey, cond) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.ip = is.readString(6, true, TafStream.String);
            response.arguments.port = is.readString(7, true, TafStream.String);
            response.arguments.dbName = is.readString(8, true, TafStream.String);
            response.arguments.tableName = is.readString(9, true, TafStream.String);
            response.arguments.vtData = is.readList(10, true, TafStream.List(TafStream.Map(TafStream.String, DCache.CacheData)));
            response.arguments.dataNum = is.readInt32(11, true, TafStream.Int32);
            response.arguments.vDataSize = is.readList(12, true, TafStream.List(TafStream.Int32));
            response.arguments.totalSize = is.readInt32(13, true, TafStream.Int32);
            response.arguments.iRet = is.readInt32(14, true, TafStream.Int32);
            response.arguments.consumeTime = is.readInt32(15, true, TafStream.Int32);
            response.arguments.err = is.readString(16, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getMKDBData', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getModuleInfo = function (appName, moduleName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.vtModuleRecord = is.readList(3, true, TafStream.List(DCache.moduleParam));
            response.arguments.err = is.readString(4, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getModuleInfo', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getModuleStruct = function (appName, moduleName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.idc = is.readString(3, true, TafStream.String);
            response.arguments.nodeNum = is.readInt32(4, true, TafStream.Int32);
            response.arguments.totalMemSize = is.readString(5, true, TafStream.String);
            response.arguments.avgMemSize = is.readString(6, true, TafStream.String);
            response.arguments.memUsage = is.readInt32(7, true, TafStream.Int32);
            response.arguments.hit = is.readInt32(8, true, TafStream.Int32);
            response.arguments.dataNum = is.readInt32(9, true, TafStream.Int32);
            response.arguments.cacheType = is.readInt32(10, true, TafStream.Int32);
            response.arguments.info = is.readList(11, true, TafStream.List(DCache.moduleServer));
            response.arguments.err = is.readString(12, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getModuleStruct', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getReleaseProgress = function (id) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.sPercent = is.readString(2, true, TafStream.String);
            response.arguments.err = is.readString(3, true, TafStream.String);
            response.arguments.vecPatchInfo = is.readList(4, true, TafStream.List(DCache.DCacheReleaseInfo));
    ...
    return this._worker.taf_invoke('getReleaseProgress', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getSwitchInfo = function (cond, index, number) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.vInfo = is.readList(4, true, TafStream.List(DCache.SwitchInfo));
            response.arguments.totalNum = is.readInt32(5, true, TafStream.Int32);
            response.arguments.err = is.readString(6, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getSwitchInfo', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getTCacheData = function (proxyObj, moduleName, sKey, keyType) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.cacheServerName = is.readString(5, true, TafStream.String);
            response.arguments.value = is.readString(6, true, TafStream.String);
            response.arguments.valueSize = is.readInt32(7, true, TafStream.Int32);
            response.arguments.valueMd5 = is.readString(8, true, TafStream.String);
            response.arguments.ver = is.readInt32(9, true, TafStream.Int32);
            response.arguments.iRet = is.readInt32(10, true, TafStream.Int32);
            response.arguments.consumeTime = is.readInt32(11, true, TafStream.Int32);
            response.arguments.err = is.readString(12, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getTCacheData', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getTDBData = function (dbaccessObj, sKey, keyType) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.ip = is.readString(4, true, TafStream.String);
            response.arguments.port = is.readString(5, true, TafStream.String);
            response.arguments.dbName = is.readString(6, true, TafStream.String);
            response.arguments.tableName = is.readString(7, true, TafStream.String);
            response.arguments.value = is.readString(8, true, TafStream.String);
            response.arguments.valueSize = is.readInt32(9, true, TafStream.Int32);
            response.arguments.valueMd5 = is.readString(10, true, TafStream.String);
            response.arguments.iRet = is.readInt32(11, true, TafStream.Int32);
            response.arguments.consumeTime = is.readInt32(12, true, TafStream.Int32);
            response.arguments.err = is.readString(13, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getTDBData', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getTransferGroup = function (cond, index, number) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.vInfo = is.readList(4, true, TafStream.List(DCache.transferInfo));
            response.arguments.totalNum = is.readInt32(5, true, TafStream.Int32);
            response.arguments.err = is.readString(6, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getTransferGroup', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getTransferInfo = function (appName, moduleName, srcGroupName) {
    ...
    return this._worker.taf_invoke('getTransferInfo', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getTransferProgress = function (appName, moduleName, srcGroupName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.vtTransferProgress = is.readList(4, true, TafStream.List(DCache.transferProgress));
            response.arguments.err = is.readString(5, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getTransferProgress', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.getTransferProgressForExpand = function (appName, moduleName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.vtTransferProgress = is.readList(3, true, TafStream.List(DCache.transferProgress));
            response.arguments.err = is.readString(4, true, TafStream.String);
    ...
    return this._worker.taf_invoke('getTransferProgressForExpand', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.installDBAccess = function (appName, serverName, serverIp, serverTemplate, isSerializated, vtModuleRecord, conf, bReplace) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.err = is.readString(9, true, TafStream.String);
    ...
    return this._worker.taf_invoke('installDBAccess', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

DCache.DCacheOptProxy.prototype.installMultiKey = function (moduleName, serviceSetName, serviceName, stRouter, stProxy, vtCacheHost, stMultiKeyConf, vtRecord, sTafVersion, bReplace) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
    ...
    return this._worker.taf_invoke('installMultiKey', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

DCache.DCacheOptProxy.prototype.installSingleKey = function (moduleName, serviceSetName, serviceName, stRouter, stProxy, vtCacheHost, stSingleKeyConf, sTafVersion, bReplace) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        os.writeString(1, moduleName);
        os.writeString(2, serviceSetName);
    ...
    var _decode = function (data) {
        try {
            ...
            response.arguments.err = is.readString(11, true, TafStream.String);
    ...
    return this._worker.taf_invoke('installSingleKey', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.installWDBAccess = function (appName, serverName, serverIp, serverTemplate, vtModuleRecord, conf, bReplace) {
    ...
    return this._worker.taf_invoke('installWDBAccess', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.reTryStopedExpand = function (appName, moduleName) {
    ...
    return this._worker.taf_invoke('reTryStopedExpand', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.recoverMirrorStat = function (sAppName, sModuleName, sGroupName, sMirrorIdc, sDBFlag, sEnableErase) {
    ...
    return this._worker.taf_invoke('recoverMirrorStat', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.releaseExpandServer = function (appName, moduleName, version, user, md5, vtCacheHost) {
    ...
    return this._worker.taf_invoke('releaseExpandServer', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.releaseServer = function (vecPatchInfo) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.releaseId = is.readInt32(2, true, TafStream.Int32);
            response.arguments.err = is.readString(3, true, TafStream.String);
    ...
    return this._worker.taf_invoke('releaseServer', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.releaseTransferServer = function (appName, moduleName, srcGroupName, version, user, md5, isDestServerExist, vtCacheHost) {
    ...
    return this._worker.taf_invoke('releaseTransferServer', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.reloadRouterConfByModuleFromDB = function (sApp, moduleName, sRouterServerName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.arguments.sResult = is.readString(4, true, TafStream.String);
    ...
    return this._worker.taf_invoke('reloadRouterConfByModuleFromDB', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.reloadRouterConfFromDB = function (sApp, sRouterServerName) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readBoolean(0, true, TafStream.Boolean);
            response.arguments.sResult = is.readString(3, true, TafStream.String);
    ...
    return this._worker.taf_invoke('reloadRouterConfFromDB', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.restoreFromGroup = function (appName, moduleName, srcGroup, destServerName, lastTime) {
    ...
    return this._worker.taf_invoke('restoreFromGroup', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.setTransferInRouterDB = function (appName, moduleName, srcGroupName) {
    ...
    return this._worker.taf_invoke('setTransferInRouterDB', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.setTransferInRouterDBV2 = function (appName, moduleName, srcGroupName, destGroupName) {
    ...
    return this._worker.taf_invoke('setTransferInRouterDBV2', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.setTransferInRouterDBforExpand = function (appName, moduleName, destGroupNames) {
    ...
    return this._worker.taf_invoke('setTransferInRouterDBforExpand', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.stopTransfer = function (appName, moduleName, srcGroupName) {
    ...
    return this._worker.taf_invoke('stopTransfer', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.stopTransferForExpand = function (appName, moduleName) {
    ...
    return this._worker.taf_invoke('stopTransferForExpand', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.stopTransferv2 = function (appName, moduleName, srcGroupName, destGroupName) {
    ...
    return this._worker.taf_invoke('stopTransferv2', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.switchByGroup = function (sAppName, sModuleName, sGroupName, bForceSwitch, iDifBinlogTime) {
    ...
    return this._worker.taf_invoke('switchByGroup', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
DCache.DCacheOptProxy.prototype.uninstall4DCache = function (uninstallInfo) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.sError = is.readString(2, true, TafStream.String);
    ...
    return this._worker.taf_invoke('uninstall4DCache', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

DCache.DCacheOptProxy.prototype.uninstall4TafServer = function (sTafServerName, sIp) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        os.writeString(1, sTafServerName);
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.sError = is.readString(3, true, TafStream.String);
    ...
    return this._worker.taf_invoke('uninstall4TafServer', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
