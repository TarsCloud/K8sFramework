...
tars.Condition.prototype = new TarsStream.JceStruct();
...
tars.Condition.prototype._equal = function (anItem) {
...
tars.MonitorQueryReq.prototype = new TarsStream.JceStruct();
...
tars.MonitorQueryReq.prototype._equal = function (anItem) {
    assert(false, 'this structure not define key operation');
}
...
tars.MonitorQueryRsp.prototype = new TarsStream.JceStruct();
...
tars.MonitorQueryRsp.prototype._equal = function (anItem) {
    assert(false, 'this structure not define key operation');
}
...
tars.MonitorQueryProxy.prototype.query = function (req) {
    ...
    var _decode = function (data) {
        try {
            ...
            response.arguments.rsp = is.readStruct(2, true, tars.MonitorQueryRsp);
    ...
    return this._worker.tars_invoke('query', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
