...
// TARS version 4.2.2 by TARS Team.
...
Common.UserInfo.prototype = new TarsStream.JceStruct();
...
Common.CheckLDAPKeyReq.prototype = new TarsStream.JceStruct();
...
Common.CheckLDAPKeyRsp.prototype = new TarsStream.JceStruct();
...
Common.LoginReq.prototype = new TarsStream.JceStruct();
...
Common.UpdatePwdReq.prototype = new TarsStream.JceStruct();
...
Common.UpdateInfoReq.prototype = new TarsStream.JceStruct();
...
Common.SearchReq.prototype = new TarsStream.JceStruct();
...
Common.LoginRsp.prototype = new TarsStream.JceStruct();
...
Common.UpdateRsp.prototype = new TarsStream.JceStruct();
...
Common.SearchRsp = function() {
    this.ret = Common.ENUM_RETURN_CODE.SUCCESS;
    this.users = new TarsStream.List(Common.UserInfo);
    this._classname = "Common.SearchRsp";
};
Common.SearchRsp.prototype = new TarsStream.JceStruct();
...
Common.SearchRsp._readFrom = function (is) {
    ...
    tmp.ret = is.readInt32(0, true, Common.ENUM_RETURN_CODE.SUCCESS);
    tmp.users = is.readList(1, false, TarsStream.List(Common.UserInfo));
    tmp._jce_double_precision_ = is.readResumePrecision();
    return tmp;
};
...
Common.LogoutReq.prototype = new TarsStream.JceStruct();
...
Common.LogoutRsp.prototype = new TarsStream.JceStruct();
...
Common.LDAPServerProxy.prototype.addUserInfo = function (req) {
    ...
    return this._worker.tars_invoke('addUserInfo', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
Common.LDAPServerProxy.prototype.checkLDAPKey = function (req) {
    ...
    return this._worker.tars_invoke('checkLDAPKey', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
Common.LDAPServerProxy.prototype.delUserInfo = function (req) {
    ...
    return this._worker.tars_invoke('delUserInfo', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
Common.LDAPServerProxy.prototype.logout = function (req) {
    ...
    return this._worker.tars_invoke('logout', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
Common.LDAPServerProxy.prototype.scanLogin = function (req) {
    ...
    return this._worker.tars_invoke('scanLogin', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
Common.LDAPServerProxy.prototype.searchByFilter = function (req) {
    ...
    return this._worker.tars_invoke('searchByFilter', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
Common.LDAPServerProxy.prototype.updatePwd = function (req) {
    ...
    return this._worker.tars_invoke('updatePwd', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
...
Common.LDAPServerProxy.prototype.updateUserInfo = function (req) {
    ...
    return this._worker.tars_invoke('updateUserInfo', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
