...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      return this.$ajax.getJSON('/server/api/template_select', {
        template_name: this.query.template_name,
        parents_name: this.query.parents_name,
    ...
    saveItem() {
      if (this.$refs.detailForm.validate()) {
        ...
        const url = model.TemplateId !== '' ? '/server/api/template_update' : '/server/api/template_create';
    ...
    removeItem(d) {
      this.$confirm(this.$t('template.delete.confirmTips'), this.$t('common.alert')).then(() => {
        const loading = this.$Loading.show();
        this.$ajax.getJSON('/server/api/template_delete', { TemplateId: d.TemplateId }).then(() => {
          loading.hide();
          this.fetchData().then(() => {
            this.$tip.success(this.$t('common.success'));
          });
