  ...
  <div class="app_index__header">
    <div class="main-width">
      ...
      <let-tabs class="tabs" :center="true" @click="clickTab" :activekey="$route.matched[0].path">
        ...
        <let-tab-pane :tab="$t('header.tab.tab6')" tabkey="/base" :icon="cacheIcon"></let-tab-pane>
        <!-- <let-tab-pane :tab="$t('header.tab.tab8')" tabkey="/gateway" :icon="operatorIcon"></let-tab-pane> -->
      </let-tabs>
